      ...
      <b-collapse is-nav id="nav_collapse">
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-item-dropdown text="User Account" right>
            <b-dropdown-item to ="/login"><i class="fa fa-user" style="padding: 5px"> Sign in </i></b-dropdown-item>
            <b-dropdown-item to ="/Info"> <i class="fa fa-cog" style="padding: 5px"> Setting</i></b-dropdown-item>
