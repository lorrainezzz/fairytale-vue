  ...
  <div class="hero">
    ...
    <div id="app1">
      <v-client-table :columns="columns" :data="authors" :options="options">
        <a slot="post" slot-scope="props" class="fa fa-plus-square-o fa-2x" @click="postFairytale()"></a>
...
export default {
  ...
  data () {
    return {
      ...
      props: ['_id'],
      errors: [],
      columns: ['_id', 'name', 'region', 'numberofFT', 'post', 'remove'],
      options: {
        perPage: 10,
        ...
        headings: {
          ...
          name: 'Author Name',
          region: 'Region',
          numberofFT: 'Numbers of fairy tales',
          post: 'Add fairy tale',
          remove: 'Remove'
        }
      }
  ...
  methods: {
    ...
    postFairytale: function () {
      this.$router.push('addFairytales')
    },
